...
import third_sem.teor_ver.lab5.functions as f
...
def show_counts():
    ...
    Label(slave, text='P1 + P2 + P3 = 1\n'
                      '({})*P1+({})*P2+({})*P3 = 0\n'
                      '({})*P1+({})*P2+({})*P3 = 0\n'.format(cm[1][0], cm[1][1], cm[1][2], cm[2][0], cm[2][1], cm[2][2]),
          font='Calibri 14', justify=LEFT).grid(row=1, column=0, columnspan=3, sticky=W)

    p1, p2, p3 = f.count_probabilities(cm)
    Label(slave, text='Теоретичні значення імовірностей', font='Calibri 14 bold') \
        .grid(row=2, column=0, columnspan=3)
    Label(slave, text='P1 = {}\n'
                      'P2 = {}\n'
                      'P3 = {}\n'.format(p1, p2, p3), font='Calibri 13', justify=LEFT)\
        .grid(row=3, column=0, columnspan=3, sticky=W)
    pe1, pe2, pe3 = f.experiment(f.model_sys(a))
    Label(slave, text='Практичні значення імовірностей', font='Calibri 14 bold') \
        .grid(row=4, column=0, columnspan=3)
    Label(slave, text='P1 = {}\n'
                      'P2 = {}\n'
                      'P3 = {}\n'. format(pe1, pe2, pe3), font='Calibri 13', justify=LEFT)\
